    ...
    <section class="frente">
        <div class="container-fluid">
           ...
           <%-- <div class="form-group">--%>
            ...
            <asp:Button ID="btnAceptar" runat="server" style='width:100px; height:30px' OnClick="btnAceptar_Click" Text="Registrar" BackColor="#0099FF" BorderColor="#0099FF" BorderStyle="None" ForeColor="White" />
